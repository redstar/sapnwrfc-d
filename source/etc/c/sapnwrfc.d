...
RFC_RC RfcSetStructure(DATA_CONTAINER_HANDLE, const(SAP_UC)*, RFC_STRUCTURE_HANDLE, out RFC_ERROR_INFO);
RFC_RC RfcSetStructureByIndex(DATA_CONTAINER_HANDLE, uint, RFC_STRUCTURE_HANDLE, out RFC_ERROR_INFO);
RFC_RC RfcSetTable(DATA_CONTAINER_HANDLE, const(SAP_UC)*, RFC_TABLE_HANDLE, out RFC_ERROR_INFO);
RFC_RC RfcSetTableByIndex(DATA_CONTAINER_HANDLE, uint, RFC_TABLE_HANDLE, out RFC_ERROR_INFO);
RFC_RC RfcSetAbapObject(DATA_CONTAINER_HANDLE, const(SAP_UC)*, RFC_ABAP_OBJECT_HANDLE, out RFC_ERROR_INFO);
