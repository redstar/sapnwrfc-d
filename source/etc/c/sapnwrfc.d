...
RFC_RC RfcSetChars(DATA_CONTAINER_HANDLE, const(SAP_UC)*, RFC_CHAR *, uint, out RFC_ERROR_INFO);
RFC_RC RfcSetCharsByIndex(DATA_CONTAINER_HANDLE, uint, RFC_CHAR *, uint, out RFC_ERROR_INFO);
RFC_RC RfcSetNum(DATA_CONTAINER_HANDLE, const(SAP_UC)*, RFC_NUM *, uint, out RFC_ERROR_INFO);
RFC_RC RfcSetNumByIndex(DATA_CONTAINER_HANDLE, uint, RFC_NUM *, uint, out RFC_ERROR_INFO);
RFC_RC RfcSetString(DATA_CONTAINER_HANDLE, const(SAP_UC)*, SAP_UC *, uint, out RFC_ERROR_INFO);
...
RFC_RC RfcSetBytes(DATA_CONTAINER_HANDLE, const(SAP_UC)*, SAP_RAW *, uint, out RFC_ERROR_INFO);
RFC_RC RfcSetBytesByIndex(DATA_CONTAINER_HANDLE, uint, SAP_RAW *, uint, out RFC_ERROR_INFO);
RFC_RC RfcSetXString(DATA_CONTAINER_HANDLE, const(SAP_UC)*, SAP_RAW *, uint, out RFC_ERROR_INFO);
